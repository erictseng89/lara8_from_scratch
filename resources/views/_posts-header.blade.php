    ...
    <div class="relative flex lg:inline-flex bg-gray-100 rounded-xl">
      ...
      <div x-data="{show: false}" @click.away="show = false">
        <button @click="show = !show"
          class="py-2 pl-3 pr-9d text-left text-sm font-semibold lg:w-32 lg:inline-flex flex">
        ...
        <div x-show="show" class="py-2 absolute bg-gray-100 rounded-xl w-full mt-2 z-30" style="display:none">
          <a href="/"
